        ...
        <div class="row">
            <div class="large-5 columns">
                ...
                <g:form controller="booking" method="GET" class="white radius">
                    ...
                    <div class="form-group"><input placeholder="Number of People" type="number" class="form-control"/>
                    </div>

                    <div class="form-group"><input placeholder="Package" type="text" class="form-control"/></div>

                    <div class="form-group"><input type="submit" value="Book My Trip" class="btn btn-lg btn-primary"/>
                    </div>
                </g:form>
            </div>
        </div>
